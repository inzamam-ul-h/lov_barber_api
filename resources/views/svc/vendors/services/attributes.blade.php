                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="section-header-breadcrumb-content">
                        <h1>
                            <?php
                            if($sub_service_id == 0){
                                echo "Manage Vendor Service's Attributes";
                            }
                            else{
                                echo "Manage Vendor Sub Service's Attributes";
                            }
                            ?>
                        </h1>
                    </div>
                            ...
                            <div class="block-content">
                                ...
                                <div class="form-group row">
                                    <div class="col-8 text-right">
                                        <a href="{{ route('vendor_services_attributes_edit', [$vend_id, $service_id, $sub_service_id]) }}" class='btn btn-primary'>
                                            Edit
                                        </a>
