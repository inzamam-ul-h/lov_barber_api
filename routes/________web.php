...
// --------------------------------------------------------------------------//
	...
	Route::get('service/coupons/', [SvcCouponController::class, 'index'])->name('svc_coupons.index');

	Route::get('service/coupons/create', [SvcCouponController::class, 'create']);

	Route::post('service/coupons/create', [SvcCouponController::class, 'store'])->name('svc_coupon_store');

	Route::get('/service/coupon/{id}',[SvcCouponController::class, 'show']);

	Route::get('/service/coupon/{id}/edit',[SvcCouponController::class, 'edit']);
	
	Route::get('/service/coupon/edit/{id}',[SvcCouponController::class, 'edit']);

	Route::patch('/service/coupon/{id}/update',[SvcCouponController::class, 'update'])->name('svc_coupon_update');
	...
	Route::get('/service/rewards',[RewardController::class, 'index']);

	Route::get('/service/reward/{id}',[RewardController::class, 'show']);

	Route::get('/service/reward/{id}/edit',[RewardController::class, 'edit']);

	Route::get('/service/rewards/create',[RewardController::class, 'create']);
