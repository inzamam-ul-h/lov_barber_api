    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="row">
                ...
                @if(Auth::user()->can('services-add') || Auth::user()->can('all'))
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 float-right">
                        <a class="btn btn-icon icon-left btn-primary pull-right" href="{{ route('services.create') }}">
        ...
        jQuery(document).ready(function(e) {
            ...
            var oTable = $('#myDataTable').DataTable({
                ...
                ajax: {
                    ...
                    url: "{!! route('svc_services_datatable') !!}",
