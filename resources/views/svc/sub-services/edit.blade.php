            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="section-header-breadcrumb-content">
                        <h1>Edit Sub Service Details</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Sub Service Details </h4>
                        </div>
                        <div class="card-body">
                            {!! Form::model($Model_Data, ['route' => ['sub-services.update', $Model_Data->id], 'method' => 'patch','files' => true]) !!}
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    {!! Form::select('service_id', $services_array, null, ['id' => 'service_id','placeholder' => 'select','class' => 'form-control','readonly']) !!}
                                </div>
                                <div class="col-sm-6">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($attributes as $record)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-primary" href="{{route('edit_svc_sub_service_attribute', $record->id)}}" title="Edit Details">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($brands as $record)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-primary" href="{{route('edit_svc_sub_service_brand', $record->id)}}" title="Edit Details">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content card card-primary">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'store_svc_sub_service_attribute']) !!}
                    <div class="block-content fs-sm">
                        @include('svc.sub-services.attribute_fields')
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
