            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="section-header-breadcrumb-content">
                        <h1>Edit Vendor Category's Attributes</h1>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Vendor Category's Attributes</h4>
                        </div>
                        <div class="card-body">
                            <div class="block-content">
                                {!! Form::model( $values_array,['route' => ['vendor-categories.update', $Model_Data->id], 'method' => 'patch']) !!}

                                @include('svc.vendors/categories.edit_fields')
