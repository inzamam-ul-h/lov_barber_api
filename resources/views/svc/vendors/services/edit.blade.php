                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Edit Vendor Services </h4>
                        </div>
                        <div class="card-body">
                            {!! Form::model($Model_Data, ['route' => ['vendor-services.update', $Model_Data->id], 'method' => 'patch','files' => true]) !!}
                            <div class="card-body">

                                @include('svc.vendors.services.edit_fields')
