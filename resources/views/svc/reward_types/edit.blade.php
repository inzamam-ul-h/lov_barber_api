                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                          ...
                          <li class="breadcrumb-item">
                            <a href="{{ url('service/reward_types') }}">Reward Types</a>
                          </li>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                          {!! Form::model($Model_Data, ['route' => ['reward-types.update', $Model_Data->id], 'method' => 'patch','files' => true]) !!}

                          @include('svc.reward_types.fields')
