    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="row">
                ...
                @if(Auth::user()->can('banners-add') || Auth::user()->can('all'))
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 float-right">
                        <a class="btn btn-icon icon-left btn-primary pull-right" href="{{ route('banners.create') }}">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-hover"  id="myDataTable">
                                            ...
                                            <tr role="row" class="heading">
                                                ...
                                                <td>
                                                    <select class="form-control" id="s_app_page_id">
                                                        <option value="-1">Select</option>
                                                        <?php
                                                        foreach($app_pages as $key => $value)
                                                        {
                                                        ?>
        ...
        @push('scripts')
            ...
            <script>
                ...
                columnDefs: [ {
                    ...
                    visible: true
                        ...
                        ajax: {
                            ...
                            data: function (d) {
                                ...
                                d.s_app_page_id = $('#s_app_page_id').val();
                            ...
                            {data: 's_app_page_id', name: 's_app_page_id'},
                    ...
                    $('#s_app_page_id').on('change', function (e) {
