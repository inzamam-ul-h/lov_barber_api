            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="section-header-breadcrumb-content">
                        <h1>Sub Service Details:  {{ $Model_Data->title }}</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Sub Service Details</h4>
                        </div>
                        <div class="card-body">
                            @include('svc.sub-services.show_fields')
                        </div>
                    </div>
                </div>
            </div>
