	...
	<section class="section">
		<div class="section-header">
			...
			<div class="row">
				...
				@if(Auth::user()->can('vendor-categories-add') || Auth::user()->can('all'))
					<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 float-right">
						<a class="btn btn-icon icon-left btn-primary pull-right" href="{{ route('vendor-categories.create') }}">
									...
									<div class="table-responsive">
										...
										<table class="table table-striped table-hover"  id="myDataTable">
											...
											<tr role="row" class="heading">
												...
												{{--                                                <td>--}}
												{{--                                                    <input type="text" class="form-control" id="s_ar_title" autocomplete="off" placeholder="Title Ar">--}}
												{{--                                                </td>--}}
                ...
                jQuery(document).ready(function(e) {
                    ...
                    var oTable = $('#myDataTable').DataTable({
                        ...
                        ajax: {
                            ...
                            url: "{!! route('svc_vendor_categories_datatable') !!}",
                            ...
                            {data: 'categories_title', name: 'categories_title'},
								...
								{{--{data: 'categories_ar_title', name: 'categories_ar_title'},--}}
