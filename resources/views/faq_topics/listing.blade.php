    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="row">
                ...
                @if(Auth::user()->can('faq-topics-add') || Auth::user()->can('all'))
                                            ...
                                            <tr role="row" class="heading">
                                                ...
                                                <td>
                                                    <select class="form-control" id="s_type">
                                                        ...
                                                        <option value="1">Service On Demand</option>
                                                        <option value="2">Ecommerce</option>
                                                        <option value="3">Classified Ads</option>
                                                    </select>
                                                </td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content card card-primary">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'faq-topics.store','files' => true]) !!}
    ...
    <script>
        ...
        jQuery(document).ready(function(e) {
            ...
            var oTable = $('#myDataTable').DataTable({
                ...
                ajax: {
                    url: "{!! route('faq_topics_datatable') !!}",
                    data: function (d) {
                        d.title = $('#s_title').val();
                        d.type = $('#s_type').val();
