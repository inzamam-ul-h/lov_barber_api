        ...
        <div class="section-header">
            ...
            <div class="row">
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('services.edit', $Model_Data->attributable_id) }}">Service Details</a>
                            </li>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 float-right">
                    <a class="btn btn-icon icon-left btn-primary pull-right" href="{{ route('services.edit', $Model_Data->attributable_id) }}">
...
{{--                            {!! Form::model($Model_Data, ['route' => ['update_svc_service_attribute', $Model_Data->id], 'method' => 'post']) !!}--}}
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content card card-primary">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'store_svc_service_attribute_option']) !!}
                    <div class="block-content fs-sm">
                        ...
                        <div class="row">
                            <div class=" form-group col-12 text-right">
                                {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
                                <a href="{{ route('edit_svc_service_attribute', $Model_Data->id) }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
