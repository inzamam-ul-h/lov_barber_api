    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="row">
                ...
                @if(Auth::user()->can('faqs-add') || Auth::user()->can('all'))
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-hover"  id="myDataTable">
                                            ...
                                            <tr role="row" class="heading">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" id="s_title" autocomplete="off" placeholder="FAQ Topic">
                                                </td>
                                                
                                                <td>
                                                    <input type="text" class="form-control" id="s_question" autocomplete="off" placeholder="Question">
                                                </td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content card card-primary">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'faqs.store','files' => true]) !!}
    ...
    <script>
        ...
        jQuery(document).ready(function(e) {
            ...
            var oTable = $('#myDataTable').DataTable({
                ...
                ajax: {
                    url: "{!! route('faqs_datatable') !!}",
                    data: function (d) {
                        d.title = $('#s_title').val();
                        d.question = $('#s_question').val();
            ...
            $('#s_question').on('keyup', function (e) {
                oTable.draw();
                e.preventDefault();
            });
