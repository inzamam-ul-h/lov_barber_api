        ...
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Vendor Sub Category's Attributes</h4>
                        </div>
                        <div class="card-body">
                            <div class="block-content">
                                ...
                                @if(Auth::user()->can('vendor-sub-categories-edit') || Auth::user()->can('all'))
                                    <div class="form-group row">
                                        <div class="col-8 text-right">
                                            <a href="{{ route('vendor-sub-categories.edit', $Model_Data->id) }}" class='btn btn-primary'>
                                                Edit
                                            </a>
                                            <a href="{{ route('vendor-sub-categories.index') }}" class="btn btn-secondary">Back</a>
                                        </div>
                                    </div>
                                @endif
