        ...
        <div class="section-header">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 float-right">
                    <a class="btn btn-icon icon-left btn-primary pull-right" href="{{ route('sub-categories.index') }}">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($Model_Data, ['route' => ['sub-categories.update', $Model_Data->id], 'method' => 'patch','files' => true]) !!}

                            @include('svc.sub_categories.fields')
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($attributes as $record)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-primary" href="{{route('edit_svc_subcat_attribute', $record->id)}}" title="Edit Details">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($brands as $record)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-primary" href="{{route('edit_svc_subcat_brand', $record->id)}}" title="Edit Details">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content card card-primary">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'store_svc_subcat_attribute']) !!}
                    <div class="block-content fs-sm">
                        @include('svc.sub_categories.attribute_fields')
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
