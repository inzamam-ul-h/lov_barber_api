    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="row">
                ...
                @if(Auth::user()->can('flower-colors-add') || Auth::user()->can('all'))
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-hover"  id="myDataTable">
                                            ...
                                            <tr role="row" class="heading">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" id="s_ar_name" autocomplete="off" placeholder="Title">
                                                </td>

                                                <td>
                                                    <input type="text" class="form-control" id="s_ar_title" autocomplete="off" placeholder="Value">
                                                </td>
        ...
        jQuery(document).ready(function(e) {
            ...
            var oTable = $('#myDataTable').DataTable({
                ...
                ajax: {
                    ...
                    url: "{!! route('flower_colors_datatable') !!}",

                    data: function (d) {

                        d.name = $('#s_name').val();

                        d.ar_name = $('#s_ar_name').val();
