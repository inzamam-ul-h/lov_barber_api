    ...
    <section class="section">
        ...
        <div class="section-header">
            ...
            <div class="row">
                ...
                @if(Auth::user()->can('vendor-sub-categories-add') || Auth::user()->can('all'))
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 float-right">
                        <a class="btn btn-icon icon-left btn-primary pull-right"
                           href="{{ route('vendor-sub-categories.create') }}">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-hover" id="myDataTable">
                                            ...
                                            <tr role="row" class="heading">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" id="s_sub_category_id" autocomplete="off" placeholder="Sub Category">
                                                </td>
        ...
        jQuery(document).ready(function(e) {
            ...
            var oTable = $('#myDataTable').DataTable({
                ...
                ajax: {
                    ...
                    url: "{!! route('svc_vendor_sub_categories_datatable') !!}",
                    ...
                    data: function (d) {
                        ...
                        d.sub_category_id = $('#s_sub_category_id').val();
            ...
            $('#s_sub_category_id').on('keyup', function (e) {
