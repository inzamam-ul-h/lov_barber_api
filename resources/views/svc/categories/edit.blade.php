        ...
        <div class="section-header">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 float-right">
                    <a class="btn btn-icon icon-left btn-primary pull-right" href="{{ route('categories.index') }}">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($Model_Data, ['route' => ['categories.update', $Model_Data->id], 'method' => 'patch','files' => true]) !!}

                            @include('svc.categories.fields')
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($attributes as $record)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-primary" href="{{route('edit_svc_attribute', $record->id)}}" title="Edit Details">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            @foreach($brands as $record)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-outline-primary" href="{{route('edit_svc_brand', $record->id)}}" title="Edit Details">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
