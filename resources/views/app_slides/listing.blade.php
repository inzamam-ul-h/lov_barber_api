    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="row">
                ...
                @if(Auth::user()->can('app-slides-add') || Auth::user()->can('all'))
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-hover"  id="myDataTable">
                                            ...
                                            <tr role="row" class="heading">
                                                ...
                                                <td>
                                                    <select class="form-control" id="s_module">
                                                        <option value="-1">Select</option>
                                                        <option value="0">Services On Demand</option>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content card card-primary">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'app-slides.store','files' => true]) !!}
...
@push('scripts')
        ...
        jQuery(document).ready(function(e) {
            ...
            var oTable = $('#myDataTable').DataTable({
                ...
                ajax: {
                    ...
                    url: "{!! route('app_slides_datatable') !!}",
    ...
    <script>
        ...
        $(document).on('click', '.btnActive', function()
        {
            ...
            $.ajax({
                url: '{{url("app-slides/deactivate")}}/'+id,
                type: 'GET',
                success: function (result) {
                    if(result==true)  {
                        location.href = "{{url("appslides/index")}}";
                        console.log("true");
                    }
        ...
        $(document).on('click', '.btnInActive', function()
        {
            ...
            $.ajax({
                url: '{{url("app-slides/activate")}}/'+id,
                type: 'GET',
                success: function (result) {
                    //console.log();
                    if(result==true)  {
        ...
        $( document ).ready(function() {
            //var id = $(this).attr("id");
            var table=$("#appslides-table").DataTable();
